import { IonApp, IonHeader, IonToolbar, IonTitle, IonContent, IonPage ,IonButtons,IonBackButton,IonGrid,IonRow,IonCol,IonRouterLink } from '@ionic/react';
                ...
                <div style={{padding:'0px 2%'}}>
                    ...
                    <IonRouterLink href="/payment4">
                        <div style={{display:'flex', justifyContent:'center'}}>
                            <button style={{width:'75%', fontSize:'18px', padding:'10px', borderRadius:'10px'}} onClick={locationFunction}>매출조회</button>
                        </div>
                    </IonRouterLink>
                </div>
            </IonContent>

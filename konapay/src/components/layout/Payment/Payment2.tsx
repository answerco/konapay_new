import { IonApp, IonHeader, IonToolbar, IonTitle, IonContent, IonLabel,IonPage ,IonButtons,IonButton,IonItem, IonBackButton,IonGrid,IonRow,IonCol,IonCheckbox,IonRouterLink } from '@ionic/react';
            ...
            <IonContent className="ion-padding">
                ...
                <div style={{padding:'0px 2%'}}>
                    ...
                    <div style={{display:'flex', justifyContent:'center'}}>
                        ...
                        <button style={{width:'75%', fontSize:'18px', padding:'10px', borderRadius:'10px'}} onClick={locationFunction} disabled={!check} >결제 요청</button>
                    </div>
                </div>
            </IonContent>
        </IonPage>

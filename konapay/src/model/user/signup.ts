...
export default class Signup {
    public static signup = async (uid: string, password: string, name: string, email: string, userType: string, payPassword: string) => {
        let payload = {uid :uid, password :password, name: name, email: email, userType: userType , payPassword : payPassword}
        console.log(payload)
